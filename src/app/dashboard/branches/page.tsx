  ...
  return (
    <div className="mx-auto w-full max-w-6xl flex-1 px-4 py-8 sm:px-6">
      <div className="animate-fade-in-up mb-6">
        <h1 className="text-2xl font-semibold tracking-tight text-slate-900 dark:text-slate-100">Branches</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400">Add branches, edit details, or archive locations you&apos;ve closed.</p>
      </div>

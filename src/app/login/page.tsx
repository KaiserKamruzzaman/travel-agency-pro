  ...
  return (
    <div className="relative flex flex-1 items-center justify-center overflow-hidden p-6">
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="animate-float-slow absolute -top-24 -left-24 h-72 w-72 rounded-full bg-sky-200/50 blur-3xl" />
        <div className="animate-float-slower absolute top-1/3 -right-24 h-80 w-80 rounded-full bg-blue-200/50 blur-3xl" />
        <div className="animate-float-slow absolute -bottom-32 left-1/3 h-72 w-72 rounded-full bg-sky-100/70 blur-3xl" />
      </div>

      <div className="animate-fade-in-up w-full max-w-sm">
        <div className="rounded-2xl border border-sky-100 bg-white/90 p-8 shadow-xl shadow-sky-900/5 backdrop-blur-sm">
          <div className="mb-6 flex flex-col items-center text-center">
            ...
            <h1 className="text-xl font-semibold text-slate-900">Wanderlust Travel</h1>
            <p className="text-sm text-slate-500">Sign in to your sales tracker</p>
          </div>
          ...
          <form action={formAction} className="space-y-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-900 outline-none transition-colors focus:border-sky-400 focus:ring-2 focus:ring-sky-100"
              />
            </div>
          ...
          <div className="mt-6 rounded-lg border border-sky-100 bg-sky-50/60 p-3 text-xs text-slate-500">
            <p className="mb-1 font-medium text-slate-600">Seed accounts</p>
